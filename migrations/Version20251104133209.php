 ...
 */
final class Version20251104133209 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE epreuve (id INT AUTO_INCREMENT NOT NULL, le_score_id INT DEFAULT NULL, nom_epreuve VARCHAR(255) NOT NULL, libelle VARCHAR(255) NOT NULL, duree DATETIME NOT NULL, difficulte INT NOT NULL, point_epreuve DOUBLE PRECISION NOT NULL, lieu_epreuve VARCHAR(255) NOT NULL, type_epreuve VARCHAR(255) NOT NULL, nb_indice_agagner INT NOT NULL, date_epreuve_debut DATETIME NOT NULL, date_epreuve_fin DATETIME NOT NULL, coeff_annee DOUBLE PRECISION NOT NULL, INDEX IDX_D6ADE47FDCA521B8 (le_score_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
